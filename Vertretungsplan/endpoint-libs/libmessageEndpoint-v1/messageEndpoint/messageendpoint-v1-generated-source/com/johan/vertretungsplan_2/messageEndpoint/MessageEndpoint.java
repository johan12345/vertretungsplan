 ...
 * on 2014-05-07 at 13:47:32 UTC 
 * Modify at your own risk.
 */

package com.johan.vertretungsplan_2.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListMessages extends MessageEndpointRequest<com.johan.vertretungsplan_2.messageEndpoint.model.CollectionResponseMessageData> {
    ...
    protected ListMessages() {
      super(MessageEndpoint.this, "GET", REST_PATH, null, com.johan.vertretungsplan_2.messageEndpoint.model.CollectionResponseMessageData.class);
    }
  ...
  /**
   * Create a request for the method "sendVertretungsplanMessage".
   *
   * This request holds the parameters needed by the the messageEndpoint server.  After setting any
   * optional parameters, call the {@link SendVertretungsplanMessage#execute()} method to invoke the
   * remote operation.
   *
   * @param school
   ...
   * @return the request
   */
  public SendVertretungsplanMessage sendVertretungsplanMessage(java.lang.String school, java.util.List<java.lang.String> changedClasses) throws java.io.IOException {
    SendVertretungsplanMessage result = new SendVertretungsplanMessage(school, changedClasses);
    initialize(result);
    return result;
  }

  public class SendVertretungsplanMessage extends MessageEndpointRequest<Void> {

    private static final String REST_PATH = "sendVertretungsplanMessage/{school}/{changedClasses}";
     ...
     * This request holds the parameters needed by the the messageEndpoint server.  After setting any
     * optional parameters, call the {@link SendVertretungsplanMessage#execute()} method to invoke the
     * remote operation. <p> {@link SendVertretungsplanMessage#initialize(com.google.api.client.google
     ...
     * @since 1.13
     */
    protected SendVertretungsplanMessage(java.lang.String school, java.util.List<java.lang.String> changedClasses) {
      super(MessageEndpoint.this, "POST", REST_PATH, null, Void.class);
      this.school = com.google.api.client.util.Preconditions.checkNotNull(school, "Required parameter school must be specified.");
      this.changedClasses = com.google.api.client.util.Preconditions.checkNotNull(changedClasses, "Required parameter changedClasses must be specified.");
    }

    @Override
    public SendVertretungsplanMessage setAlt(java.lang.String alt) {
      return (SendVertretungsplanMessage) super.setAlt(alt);
    }

    @Override
    public SendVertretungsplanMessage setFields(java.lang.String fields) {
      return (SendVertretungsplanMessage) super.setFields(fields);
    }

    @Override
    public SendVertretungsplanMessage setKey(java.lang.String key) {
      return (SendVertretungsplanMessage) super.setKey(key);
    }

    @Override
    public SendVertretungsplanMessage setOauthToken(java.lang.String oauthToken) {
      return (SendVertretungsplanMessage) super.setOauthToken(oauthToken);
    }

    @Override
    public SendVertretungsplanMessage setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendVertretungsplanMessage) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendVertretungsplanMessage setQuotaUser(java.lang.String quotaUser) {
      return (SendVertretungsplanMessage) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendVertretungsplanMessage setUserIp(java.lang.String userIp) {
      return (SendVertretungsplanMessage) super.setUserIp(userIp);
    }
    ...
    public SendVertretungsplanMessage setSchool(java.lang.String school) {
      this.school = school;
      return this;
    }

    @com.google.api.client.util.Key
    private java.util.List<java.lang.String> changedClasses;

    /**

     */
    public java.util.List<java.lang.String> getChangedClasses() {
      return changedClasses;
    }

    public SendVertretungsplanMessage setChangedClasses(java.util.List<java.lang.String> changedClasses) {
      this.changedClasses = changedClasses;
      return this;
    }

    @Override
    public SendVertretungsplanMessage set(String parameterName, Object value) {
      return (SendVertretungsplanMessage) super.set(parameterName, value);
    }
  }
